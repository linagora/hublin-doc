...
Once [configured](/getting-started/configuration), and all services are up i.e. MongoDB, Redis, Janus (optional based on your requirements), you can start Hublin with
